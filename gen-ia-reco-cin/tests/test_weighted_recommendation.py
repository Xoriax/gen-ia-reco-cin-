...
if __name__ == "__main__":
    ...
    try:
        ...
        print(" OK EF3.1 : Formule de score pondérée (similarité × poids thématique)")
        print(" OK EF3.2 : Top 3 propositions avec scores les plus élevés")
        print(" OK Score de Couverture Sémantique calculé et fonctionnel")
        print("\n")
